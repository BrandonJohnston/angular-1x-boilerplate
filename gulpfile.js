...
gulp.task('sass', function() {
    return eventStream.merge(
        compileSass(sourcePaths.sass, distPaths.distDir + '/static', 'application.css'),
        compileSass(sourcePaths.sass, distPaths.distDir + '/static', 'application.min.css', true)
    );
});
